...
from app.models import Restaurant, Meal, Order, OrderDetails, Driver
from app.serializers import RestaurantSerializer, MealSerializer, OrderSerializer

import stripe
from qpizza.settings import STRIPE_API_KEY
...
def driver_get_revenue(request):
	...
	for day in current_weekdays:
		...
		# below is an example of: revenue["Monday"]
